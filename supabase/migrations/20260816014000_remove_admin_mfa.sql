...
-- Administrator privileges return to password-authenticated site_admins members.
-- The official-origin guard remains an independent browser-side restriction.
